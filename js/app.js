(() => {
    ...
    function initSliders() {
        if (document.querySelector(".delivery__cards")) new swiper_core_Swiper(".delivery__cards", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".text-feedback__slider")) new swiper_core_Swiper(".text-feedback__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".video-feedback__slider")) new swiper_core_Swiper(".video-feedback__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".photo-feedback__slider")) new swiper_core_Swiper(".photo-feedback__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
